...
class Messages
{
     ...
     *          @option string "text"
     */
    public function sendSms(string|array $phone, string $text, ?string $sender = null, array $params = []): object
    {
        return $this->master->call('messages/send_sms', array_merge([
            'phone'  => $phone,
            'text'   => $text,
            'sender' => $sender,
        ], $params));
     ...
     *          @option string "text"
     */
    public function sendPersonalized(array $messages, ?string $sender = null, array $params = []): object
    {
        return $this->master->call('messages/send_personalized', array_merge([
            'messages' => $messages,
            'sender'   => $sender,
        ], $params));
    }
     ...
     *          @option string "text"
     */
    public function sendVoice(string|array $phone, array $params = []): object
    {
        return $this->master->call('messages/send_voice', array_merge([
            'phone' => $phone,
        ], $params));
    }
     ...
     *          @option string "text"
     */
    public function sendMms(string|array $phone, string $title, array $params = []): object
    {
        return $this->master->call('messages/send_mms', array_merge([
            'phone' => $phone,
            'title' => $title,
        ], $params));
    }
     ...
     */
    public function view(string $id, array $params = []): object
    {
        return $this->master->call('messages/view', array_merge(['id' => $id], $params));
    }
     ...
     *              @option string "description"
     */
    public function reports(array $params = []): object
    {
     ...
     *      @option bool "success"
     */
    public function delete(string|array $id, string|array|null $unique_id = null): object
    {
        return $this->master->call('messages/delete', [
            'id'        => $id,
            'unique_id' => $unique_id,
        ]);
    }
     ...
     *          @option string "phone"
     *          @option string "received" Date of received message
     ...
     *              @option string "description"
     */
    public function received(string $type, array $params = []): object
    {
        return $this->master->call('messages/received', array_merge(['type' => $type], $params));
    }
}
